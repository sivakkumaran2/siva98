    ...
    <div className="grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]">
      ...
      <div className="flex flex-col">
        ...
        <div className="text-left p-4">
          ...
          <h5 className="text-2xl text-black-500 font-bold">WhatsApp Stores</h5>
          </div>
          <div className="text-right p-4">
        <Link to="/newStore"><Button style={{ backgroundColor: '#0000FF', color: 'white' }} >+ Create new store</Button></Link>
          </div>
        </div>
