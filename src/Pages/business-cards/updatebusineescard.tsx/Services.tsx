...
return (
  ...
  <div className="grid w-full max-w-sm items-center gap-1.5">
    ...
    <h5 className="font-sans">
    Service Name
  <Input type="Reviewer Name" placeholder="Service Name" />
    </h5>
<h5 className="font-sans">
Service Description *
  <Input type="Reviewer Name" placeholder="  Service Description" />
    </h5>
    <h5 className="font-sans">
   <label htmlFor="number-input">Enquiry Button
 </label>
<Select>
      ...
      <SelectContent>
        <SelectGroup>
          ...
          <SelectItem value="In">Enable</SelectItem>
          <SelectItem value="Out">Disable</SelectItem>
...
<button className="bg-blue-500 hover:bg-blue-700 text-white w-20 font-bold py-2 px-4 border border-blue-700 rounded">
  ...
  <CardFooter className="flex justify-between">
   ...
   <Link to="/products"><Button>Submit & Next</Button></Link>
